...
<body themebg-pattern="theme1">
    ...
    <section class="login-block">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <form class="md-float-material form-material" method="POST" action="/auth/register/save"
                        autocomplete="off">
                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                ...
                                <div class="form-group form-primary">
                                    ...
                                    <span
                                        class="text-danger"><?=isset($validation) ? display_error($validation, 'fullname') : ''?></span>
...
<!-- Mirrored from technext.github.io/material_able/auth-sign-up.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Jun 2021 09:41:25 GMT -->
